...
#import "HelveticaNeueComLabel.h"

@implementation HelveticaNeueComLabel

- (void)awakeFromNib {
    self.font = [UIFont fontWithName:@"Helvetica Neue LT Com" size:self.font.pointSize];
